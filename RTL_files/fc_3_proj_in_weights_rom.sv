...
/****************************************************************************************
File name:      fc_3_proj_in_weights_rom.sv
  
Description:    rom of weights of fc_3_proj_in layer
...
module fc_3_proj_in_weights_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_3_proj_in_weights.mem"}, mem);
  end
...
endmodule : fc_3_proj_in_weights_rom
