...
/****************************************************************************************
File name:      fc_proj_out_bias_rom.sv
  
Description:    rom of biases of fc_proj_out layer
...
module fc_proj_out_bias_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_proj_out_bias.mem"}, mem);
  end
...
endmodule : fc_proj_out_bias_rom
