...
/****************************************************************************************
File name:      fc_2_proj_in_weights_rom.sv
  
Description:    rom of weights of fc_2_proj_in layer
...
module fc_2_proj_in_weights_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_2_proj_in_weights.mem"}, mem);
  end
...
endmodule : fc_2_proj_in_weights_rom
