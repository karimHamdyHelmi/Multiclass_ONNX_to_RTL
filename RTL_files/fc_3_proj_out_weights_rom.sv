...
/****************************************************************************************
File name:      fc_3_proj_out_weights_rom.sv
  
Description:    rom of weights of fc_3_proj_out layer
...
module fc_3_proj_out_weights_rom #(
  parameter int DEPTH  = 25,
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_3_proj_out_weights.mem"}, mem);
  end
...
endmodule : fc_3_proj_out_weights_rom
