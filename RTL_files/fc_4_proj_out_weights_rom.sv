...
/****************************************************************************************
File name:      fc_4_proj_out_weights_rom.sv
  
Description:    rom of weights of fc_4_proj_out layer
...
module fc_4_proj_out_weights_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_4_proj_out_weights.mem"}, mem);
  end
...
endmodule : fc_4_proj_out_weights_rom
