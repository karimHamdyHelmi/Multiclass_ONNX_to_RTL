...
/****************************************************************************************
File name:      fc_proj_in_bias_rom.sv
  
Description:    rom of biases of fc_proj_in layer
...
module fc_proj_in_bias_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_proj_in_bias.mem"}, mem);
  end
