...
/****************************************************************************************
File name:      fc_proj_in_weights_rom.sv
  
Description:    rom of weights of fc_proj_in layer
...
module fc_proj_in_weights_rom #(
  parameter int DEPTH  = 1432,
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_proj_in_weights.mem"}, mem);
  end
...
endmodule : fc_proj_in_weights_rom
