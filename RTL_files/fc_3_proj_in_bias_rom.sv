...
/****************************************************************************************
File name:      fc_3_proj_in_bias_rom.sv
  
Description:    rom of biases of fc_3_proj_in layer
...
module fc_3_proj_in_bias_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/fc_3_proj_in_bias.mem"}, mem);
  end
...
endmodule : fc_3_proj_in_bias_rom
