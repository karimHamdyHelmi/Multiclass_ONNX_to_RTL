...
/****************************************************************************************
File name:      conv2d_1_proj_in_bias_rom.sv
  
Description:    Bias ROM for conv layer conv2d_1_proj_in (BIAS_WIDTH=32 per filter)
...
module conv2d_1_proj_in_bias_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/conv2d_1_proj_in_bias.mem"}, mem);
  end
...
endmodule : conv2d_1_proj_in_bias_rom
