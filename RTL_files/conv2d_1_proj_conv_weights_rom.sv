...
/****************************************************************************************
File name:      conv2d_1_proj_conv_weights_rom.sv
  
Description:    Weights ROM for conv layer conv2d_1_proj_conv
...
module conv2d_1_proj_conv_weights_rom #(
  ...
  initial begin
    $readmemh({`__FILE__, "/../mem_files/conv2d_1_proj_conv_weights.mem"}, mem);
  end
...
endmodule : conv2d_1_proj_conv_weights_rom
